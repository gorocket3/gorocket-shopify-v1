...
export default function getInitialColumns(data, showChangesModal, showSeoLogsModal, showTagsModal, onlineStoreLinkCallback, editedCellCallback) {
    ...
    const getDefaultFilterParams = (type = 'set', options = {}) => {
        ...
        if (type === 'text') {
            let filterOptions = [ "contains" ];
            if (options.blankFilter) {
                filterOptions.push(textBlankFilterOption);
            }
        ...
        const { blankFilter, ...restOptions } = options;
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    width: 200,
                    filter: "agTextColumnFilter",
                    filterParams: getDefaultFilterParams('text', { blankFilter: true }),
                    cellStyle: cellMergeStyling,
                    cellClass: 'hd-grid-left',
