...
import ProgressNotifier from "../common/progress-notifier";
                    ...
                    <Box>
                        <BlockStack inlineAlign="center" gap="100">
                            ...
                            {info.plan?.id && info.plan.id < 3 && (() => {
                                ...
                                return (
                                    <p>
                                        With the <PolarisLink monochrome
                                                              onClick={() => goToChargesPage(nextPlan?.id || null)}>
                                        {nextPlan?.name || ''} Plan
                                    </PolarisLink>, you can perform up
                                        to {formatNumberWithCommas(nextPlan?.limits?.edit_limit || 0)} bulk edits and
                                        generate up to {formatNumberWithCommas(nextPlan?.limits?.ai_limit || 0)} AI SEO
                                        per day.
                                    </p>
                                );
                            })()}
